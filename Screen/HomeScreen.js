...
const HomeScreen = () => {
  return (
    <View>
        ...
        <View>
            <LottieView style={styles.imageNews}
            source={require('../lottie/29447-global-mobile-news-network.json')}
            autoPlay />
            <TouchableOpacity style={styles.buttonNews}>
                <Text style={{fontSize: 15, color: '#000000', fontWeight: 'bold', textAlign: 'center', padding: 10, fontFamily: 'Poppins'}}>News</Text>
            </TouchableOpacity>
        </View>
        <View>
            <LottieView style={styles.imageCovid19}
            source={require('../lottie/30328-corona-virus.json')}
            autoPlay />
            <TouchableOpacity style={styles.buttonCovid19}>
                <Text style={{fontSize: 15, color: '#000000', fontWeight: 'bold', textAlign: 'center', padding: 10, fontFamily: 'Poppins'}}>Covid-19</Text>
            </TouchableOpacity>
        </View>
